        ...
        <div className="bg-green-400">
            <div className="container mx-auto sm:p-2">
                <div className="flex justify-between items-center px-5 sm:px-0">
                    ...
                    <div className={clsx(`md:flex fixed md:static h-screen md:h-auto
                                    bg-green-400 md:bg-transparent top-0  w-full
                                    flex justify-center items-center z-10 duration-500`,
                        nav ? 'left-0' : '-left-full'
                    )}>
                        <div
                            onClick={() => setNav(!nav)}
                            className="absolute md:hidden top-24 right-3 border border-white w-10 h-10
                             flex justify-center items-center rounded-full cursor-pointer"
                        >
                            <AiOutlineClose size={25} color='black' />
                        </div>
                        <ul className="md:flex md:space-x-3 space-y-4 md:space-y-0">
                            <li className='hover:text-white'>Home</li>
                            <li className='hover:text-white'>Why?</li>
                    ...
                    <div className='flex items-center justify-center space-x-3'>
                        ...
                        <div
                            ...
                            className='md:hidden cursor-pointer
                             hover:bg-slate-400 hover:text-white p-1 hover:rounded-full'>
